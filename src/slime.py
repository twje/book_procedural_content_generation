    ...
    def __init__(self, position, groups):
        ...
        anim_states = [
            (ANIMATION_STATE.WALK_UP.value,
             "../resources/enemies/slime/spr_slime_walk_up.png"),
            (ANIMATION_STATE.WALK_RIGHT.value,
             "../resources/enemies/slime/spr_slime_walk_right.png"),
            (ANIMATION_STATE.WALK_DOWN.value,
             "../resources/enemies/slime/spr_slime_walk_down.png"),
            (ANIMATION_STATE.WALK_LEFT.value,
             "../resources/enemies/slime/spr_slime_walk_left.png"),
            (ANIMATION_STATE.IDLE_UP.value,
             "../resources/enemies/slime/spr_slime_idle_up.png"),
            (ANIMATION_STATE.IDLE_RIGHT.value,
             "../resources/enemies/slime/spr_slime_idle_right.png"),
            (ANIMATION_STATE.IDLE_DOWN.value,
             "../resources/enemies/slime/spr_slime_idle_down.png"),
            (ANIMATION_STATE.IDLE_LEFT.value,
             "../resources/enemies/slime/spr_slime_idle_left.png")
        ]
